...
import std2 from '@/assets/img/service/software dev.jpg'
import std3 from '@/assets/img/service/digital trans.png'
...
const services: Std[] = [
 { img: std1, title: 'Salesforce services', link: '/Salesforce-services' },
  { img: std3, title: 'Digital transformation', link: '/Digital-transformation' },
  { img: std2, title: 'Software development', link: '/Software-development' },
]
