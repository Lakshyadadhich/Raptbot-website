...
import TopicDetails from '../automating-legal-agreement-process/components/Detail'
...
const page = () => {
  return (
    <MainLayout>
      <main>
        <PageTitle
          title="Automating legal agreement process"
          items={[
            { label: 'home', link: '/' },
            { label: 'case studies', link: '/case-studies' },
            { label: 'automating legal agreement process', link: '/automating-legal-agreement-process' },
          ]}
        />
