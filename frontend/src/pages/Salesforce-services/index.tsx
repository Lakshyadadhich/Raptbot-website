import std1 from '@/assets/img/service/digital trans.png'
...
const services: Std[] = [
  { img: std1, title: 'Digital transformation', link: '/Digital-transformation' },
      ...
      <main>
        <PageTitle
          ...
          items={[
            ...
            { label: 'salesforce services', link: '/Salesforce-services' },
          ]}
        />
